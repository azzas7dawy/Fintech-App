      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('You Pay', style: TextStyle(color: AppColors.gray, fontSize: 13)),
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 22,
                      color: theme.brightness == Brightness.dark ? AppColors.mainColor : AppColors.darkModeContainerColor,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.attach_money, size: 18, color: Colors.orangeAccent),
                      const SizedBox(width: 6),
                      Text(state.payCurrency, style: TextStyle(color: theme.brightness == Brightness.dark ? AppColors.mainColor: Colors.black87)),
                      const SizedBox(width: 4),
                      const Icon(Icons.keyboard_arrow_down, size: 18,color: AppColors.mainColor,),
                    ],
                  ),
                )
              ],
            ...
            Divider(color: theme.brightness == Brightness.dark ? Colors.white10 : Colors.grey.shade300, height: 1),
            const SizedBox(height: 12),

            // You Receive label (no toggle)
            const Text('You Receive', style: TextStyle(color: Colors.grey, fontSize: 13)),
            const SizedBox(height: 6),
            Row(
              children: [
                Expanded(
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        width: 26,
                        height: 26,
                        decoration: BoxDecoration(shape: BoxShape.circle, color:AppColors.darkModeBackGroundColor),
                        child: Center(child: Text(state.receiveCurrency[0], style: const TextStyle(fontWeight: FontWeight.bold))),
                      ),
                      const SizedBox(width: 8),
                      Text(state.receiveCurrency,style: TextStyle(color: AppColors.mainColor),),
                      const SizedBox(width: 4),
                      const Icon(Icons.keyboard_arrow_down, size: 18,color: AppColors.mainColor,),
                    ],
                  ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text('1 USD = 0.00078 ETH', style: TextStyle(color: Colors.grey.shade500)),
            ],
          )
          ],
        ),
